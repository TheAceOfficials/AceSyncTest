...
function EpisodeDetailsApp() {
  try {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[var(--background-dark)] to-[var(--secondary-color)]" data-name="episode-details-app" data-file="episode-details-app.js">
        <Header />
    ...
    console.error('EpisodeDetailsApp component error:', error);
    return null;
  }
}
