...
function UserProfileApp() {
  try {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[var(--background-dark)] to-[var(--secondary-color)]" data-name="user-profile-app" data-file="user-profile-app.js">
        <Header />
        <UserProfileContent />
        <Footer />
      </div>
    ...
    console.error('UserProfileApp component error:', error);
    return null;
  }
}
