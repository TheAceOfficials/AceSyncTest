...
function App() {
  try {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[var(--background-dark)] to-[var(--secondary-color)]" data-name="app" data-file="app.js">
        <Sidebar />
        <div className="ml-20 transition-all duration-500">
          <Header />
          {isAuthenticated ? <HeroSlider /> : <Hero />}
          <ContinueWatching />
          <UpNext />
          <WatchlistSection />
          <UpcomingSchedule />
