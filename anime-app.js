...
function AnimeApp() {
  try {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[var(--background-dark)] to-[var(--secondary-color)]" data-name="anime-app" data-file="anime-app.js">
        <Header />
        <AnimeContent />
        <Footer />
      </div>
    ...
    console.error('AnimeApp component error:', error);
    return null;
  }
}
